...
class OrderCreatedHandler(EventHandler):
    ...
    def handle(self, event_data: Dict[str, Any]) -> None:
        ...
        try:
            ...
            session.commit()
            event_data['event'] = "StockDecreased" # Si la mise à jour du stock a réussi, déclenchez StockDecreased.
        except Exception as e:
            session.rollback()
            event_data['event'] = "StockDecreaseFailed" # Si la mise à jour du stock a échoué, déclenchez StockDecreaseFailed.
